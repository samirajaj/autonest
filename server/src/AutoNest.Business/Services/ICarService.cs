...
public interface ICarService
{
    ...
    Task<(byte[] Data, string ContentType)?> GetImageAsync(int imageId, CancellationToken ct);
    ...
    Task<PagedResult<CarSummaryDto>?> CurrentCompanyCarsAsync(int page, int pageSize, bool includeDeleted, CancellationToken ct);
